      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(width: MediaQuery.of(context).size.width, height: MediaQuery.of(context).size.height/1.5, child: VideoPlayer(controller),),
            const SizedBox(height: 30,),
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: TextInputField(controller: _songController, labelText: 'Song Text', icon: Icons.music_note,),
                  ),
